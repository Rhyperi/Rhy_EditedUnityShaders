	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 frag(VertexOutput i) : COLOR
			{
                ...
                float3 emissive = ((_EmissionMap_var.rgb*_EmissiveColor.rgb*_PBREmissiveIntensity)+((saturate((_PatternColor.rgb*saturate((1.0 - (node_1333*(node_1333-(0.0+(10.0*node_1162))))))))*_EmissiveIntensity)+(_PatternColor.rgb*node_8264)));
