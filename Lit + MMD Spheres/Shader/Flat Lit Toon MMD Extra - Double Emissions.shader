Shader "Rhy Custom Shaders/Toon + Spheres/2x Emissions"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			{			
				...
				if(light_Env != 1)
					finalColor = (emissive + emissive2) + (Matcap.Add + (_ColorIntensity * (baseColor.rgb * toonTexColor) * Matcap.Mul)) * Lighting.lightCol;
