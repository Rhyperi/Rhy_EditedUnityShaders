	...
	SubShader
	{
		...
		Pass
		{
			...
			{			
				...
				//float3 finalColor = baseColor.rgb;
				float3 finalColor = ((_ColorIntensity / 2) * baseColor.rgb * toonTexColor * (Matcap.Mul + (Matcap.Add + Matcap2.Add.rgb))) * (lerp(Lighting.indirectLit, Lighting.directLit, attenuation));
