...
public class HologramShaderGUI : ShaderGUI
{
    ...
    //Texture Animation
    private MaterialProperty Cols = null;
    private MaterialProperty Rows = null;
    private MaterialProperty FrameLength = null;
    ...
    void AssignProperties()
    {
        ...
        Cols = FindProperty("_Cols", _props);
        Rows = FindProperty("_Rows", _props);
        FrameLength = FindProperty("_Frame", _props);
    }
    ...
    void DrawBanner()
    {
        ...
        if (bannerTex != null)
        {
            ...
            EditorGUI.LabelField(rect, "Hologram Shader (Edited)", title);
    ...
    void DrawGeneralSettings()
    {
        ...
        _materialEditor.ShaderProperty(Cols, "Columns");
        _materialEditor.ShaderProperty(Rows, "Rows");
        _materialEditor.ShaderProperty(FrameLength, "Frame Length");
        EditorGUI.indentLevel--;
    }
